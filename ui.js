...
function openTradeForm(record) {
  ...
  if (!isEdit) {
    ...
    var buyInput = form.querySelector('[name="buyPrice"]');
    ...
    buyInput.addEventListener('input', calcFee);
    buyInput.addEventListener('change', calcFee);
